...
var Yr = "end-of-life";
var zr = "not-allowed";
var Wr = "connection-error";
var Hr = "cam-in-use";
var Qr = "mic-in-use";
var Kr = "cam-mic-in-use";
var Xr = "permissions";
var Zr = "undefined-mediadevices";
var ei = "not-found";
var ti = "constraints";
var ni = "unknown";
...
var wi = "meeting-session-data-error";
...
export {
  Lr as DAILY_ACCESS_LEVEL_FULL,
  Ir as DAILY_ACCESS_LEVEL_LOBBY,
  Nr as DAILY_ACCESS_LEVEL_NONE,
  xr as DAILY_ACCESS_UNKNOWN,
  Kr as DAILY_CAMERA_ERROR_CAM_AND_MIC_IN_USE,
  Hr as DAILY_CAMERA_ERROR_CAM_IN_USE,
  ti as DAILY_CAMERA_ERROR_CONSTRAINTS,
  Qr as DAILY_CAMERA_ERROR_MIC_IN_USE,
  ei as DAILY_CAMERA_ERROR_NOT_FOUND,
  Xr as DAILY_CAMERA_ERROR_PERMISSIONS,
  Zr as DAILY_CAMERA_ERROR_UNDEF_MEDIADEVICES,
  ni as DAILY_CAMERA_ERROR_UNKNOWN,
  yi as DAILY_EVENT_ACCESS_STATE_UPDATED,
  Gi as DAILY_EVENT_ACTIVE_SPEAKER_CHANGE,
  qi as DAILY_EVENT_ACTIVE_SPEAKER_MODE_CHANGE,
  Ni as DAILY_EVENT_APP_MSG,
  ui as DAILY_EVENT_CAMERA_ERROR,
  Wi as DAILY_EVENT_CPU_LOAD_CHANGE,
  ao as DAILY_EVENT_ERROR,
  Ki as DAILY_EVENT_EXIT_FULLSCREEN,
  Hi as DAILY_EVENT_FACE_COUNTS_UPDATED,
  Qi as DAILY_EVENT_FULLSCREEN,
  ii as DAILY_EVENT_IFRAME_LAUNCH_CONFIG,
  ri as DAILY_EVENT_IFRAME_READY_FOR_LAUNCH_CONFIG,
  io as DAILY_EVENT_INPUT_SETTINGS_UPDATED,
  hi as DAILY_EVENT_JOINED_MEETING,
  di as DAILY_EVENT_JOINING_MEETING,
  no as DAILY_EVENT_LANG_UPDATED,
  pi as DAILY_EVENT_LEFT_MEETING,
  to as DAILY_EVENT_LIVE_STREAMING_ERROR,
  Xi as DAILY_EVENT_LIVE_STREAMING_STARTED,
  eo as DAILY_EVENT_LIVE_STREAMING_STOPPED,
  Zi as DAILY_EVENT_LIVE_STREAMING_UPDATED,
  ci as DAILY_EVENT_LOADED,
  ai as DAILY_EVENT_LOADING,
  si as DAILY_EVENT_LOAD_ATTEMPT_FAILED,
  $i as DAILY_EVENT_LOCAL_SCREEN_SHARE_CANCELED,
  Vi as DAILY_EVENT_LOCAL_SCREEN_SHARE_STARTED,
  Ji as DAILY_EVENT_LOCAL_SCREEN_SHARE_STOPPED,
  wi as DAILY_EVENT_MEETING_SESSION_DATA_ERROR,
  bi as DAILY_EVENT_MEETING_SESSION_STATE_UPDATED,
  _i as DAILY_EVENT_MEETING_SESSION_SUMMARY_UPDATED,
  zi as DAILY_EVENT_NETWORK_CONNECTION,
  Yi as DAILY_EVENT_NETWORK_QUALITY_CHANGE,
  oo as DAILY_EVENT_NONFATAL_ERROR,
  mi as DAILY_EVENT_PARTICIPANT_COUNTS_UPDATED,
  fi as DAILY_EVENT_PARTICIPANT_JOINED,
  vi as DAILY_EVENT_PARTICIPANT_LEFT,
  gi as DAILY_EVENT_PARTICIPANT_UPDATED,
  ro as DAILY_EVENT_RECEIVE_SETTINGS_UPDATED,
  Ii as DAILY_EVENT_RECORDING_DATA,
  xi as DAILY_EVENT_RECORDING_ERROR,
  Ai as DAILY_EVENT_RECORDING_STARTED,
  ji as DAILY_EVENT_RECORDING_STATS,
  Di as DAILY_EVENT_RECORDING_STOPPED,
  Li as DAILY_EVENT_RECORDING_UPLOAD_COMPLETED,
  Bi as DAILY_EVENT_REMOTE_MEDIA_PLAYER_STARTED,
  Ui as DAILY_EVENT_REMOTE_MEDIA_PLAYER_STOPPED,
  Fi as DAILY_EVENT_REMOTE_MEDIA_PLAYER_UPDATED,
  li as DAILY_EVENT_STARTED_CAMERA,
  oi as DAILY_EVENT_THEME_UPDATED,
  Ci as DAILY_EVENT_TRACK_STARTED,
  Mi as DAILY_EVENT_TRACK_STOPPED,
  Pi as DAILY_EVENT_TRANSCRIPTION_ERROR,
  Ri as DAILY_EVENT_TRANSCRIPTION_MSG,
  Ti as DAILY_EVENT_TRANSCRIPTION_STARTED,
  Oi as DAILY_EVENT_TRANSCRIPTION_STOPPED,
  Si as DAILY_EVENT_WAITING_PARTICIPANT_ADDED,
  Ei as DAILY_EVENT_WAITING_PARTICIPANT_REMOVED,
  ki as DAILY_EVENT_WAITING_PARTICIPANT_UPDATED,
  Wr as DAILY_FATAL_ERROR_CONNECTION,
  Fr as DAILY_FATAL_ERROR_EJECTED,
  Yr as DAILY_FATAL_ERROR_EOL,
  Jr as DAILY_FATAL_ERROR_EXP_ROOM,
  $r as DAILY_FATAL_ERROR_EXP_TOKEN,
  qr as DAILY_FATAL_ERROR_MEETING_FULL,
  Ur as DAILY_FATAL_ERROR_NBF_ROOM,
  Vr as DAILY_FATAL_ERROR_NBF_TOKEN,
  zr as DAILY_FATAL_ERROR_NOT_ALLOWED,
  Gr as DAILY_FATAL_ERROR_NO_ROOM,
  Br as DAILY_RECEIVE_SETTINGS_ALL_PARTICIPANTS_KEY,
  Rr as DAILY_RECEIVE_SETTINGS_BASE_KEY,
  Mr as DAILY_STATE_ERROR,
  Er as DAILY_STATE_JOINED,
  kr as DAILY_STATE_JOINING,
  Cr as DAILY_STATE_LEFT,
  br as DAILY_STATE_NEW,
  Tr as DAILY_TRACK_STATE_BLOCKED,
  Dr as DAILY_TRACK_STATE_INTERRUPTED,
  Ar as DAILY_TRACK_STATE_LOADING,
  Or as DAILY_TRACK_STATE_OFF,
  jr as DAILY_TRACK_STATE_PLAYABLE,
  Pr as DAILY_TRACK_STATE_SENDABLE,
  es as default
};
